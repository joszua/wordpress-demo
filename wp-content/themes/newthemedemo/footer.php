        ...
        <div class="group">
          <div class="site-footer__col-one">
            <h1 class="school-logo-text school-logo-text--alt-color">
              <a href="<?php echo site_url() ?>"><strong>WordPress</strong> Demo</a>
            </h1>
          ...
          <div class="site-footer__col-two-three-group">
            <div class="site-footer__col-two">
              ...
              <nav class="nav-list">
                <ul>
                  <li><a style="color: #3f3f3f;" href="<?php echo site_url('/about-us') ?>">About Us</a></li>
                  <li><a style="color: #3f3f3f;" href="#">Programs</a></li>
                  <li><a style="color: #3f3f3f;" href="#">Events</a></li>
                  <li><a style="color: #3f3f3f;" href="#">Campuses</a></li>
                </ul>
              </nav>
            </div>
            ...
            <div class="site-footer__col-three">
              ...
              <nav class="nav-list">
                <ul>
                  <li><a style="color: #3f3f3f;" href="#">Legal</a></li>
                  <li><a style="color: #3f3f3f;" href="<?php echo site_url('/privacy-policy-2') ?>">Privacy</a></li>
                  <li><a style="color: #3f3f3f;" href="#">Careers</a></li>
                </ul>
              </nav>
            </div>
          </div>
